...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">CV. Kopi Rakjat</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            {{-- Data Profil Toko  --}}
                            <a class="nav-link" href="/profil_toko">
                            ...
                            <div class="collapse" id="collapseProduk" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/kategori">Data Kategori Produk</a>
                            ...
                            <div class="collapse" id="collapsePenjualan" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/transaksi_proses">Proses Transaksi</a>
                                    <a class="nav-link" href="/transaksi_selesai">Transaksi Selesai</a>
                                </nav>
                            </div>

                            {{-- Menu petani  --}}
                            <a class="nav-link" href="/petani">
                                <div class="sb-nav-link-icon"><i class="fas fa-blind"></i></div>
                                Data Petani
                            </a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; CV. Kopi Rakjat 2021</div>
                            {{-- <div>
